...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Building AI-powered systems and scalable web products. RAG, LLM orchestration, and SaaS engineering.",
  },
};
    ...
    <section className="border-y hairline bg-[var(--surface-subtle)]">
      <div className="container-page py-24 md:py-32">
        <div className="flex items-end justify-between gap-6">
          ...
          <Link href="/work" className="hidden link-underline text-sm md:inline-flex">
            All case studies →
          </Link>
        </div>
      ...
      <div className="container-page py-24 md:py-32">
        <div className="grid gap-12 md:grid-cols-12">
          <div className="md:col-span-5">
            ...
            <Link href="/services" className="link-underline mt-6 inline-flex text-sm">
              See how I work →
            </Link>
          </div>
